...
export const v2rayDefault: z.infer<typeof v2raySchema> = {
  type: 'none',
  tls: 'none',
  net: 'tcp',
  scy: 'auto',
...
export const ssDefault: z.infer<typeof ssSchema> = {
  plugin: '',
  method: 'aes-128-gcm',
  obfs: 'http',
  host: '',
...
export const ssrDefault: z.infer<typeof ssrSchema> = {
  method: 'aes-128-cfb',
  proto: 'origin',
  obfs: 'plain',
  name: '',
...
export const trojanDefault: z.infer<typeof trojanSchema> = {
  method: 'origin',
  obfs: 'none',
  allowInsecure: false,
  host: '',
...
export const tuicDefault: z.infer<typeof tuicSchema> = {
  name: '',
  port: 0,
  server: '',
  alpn: '',
...
export const juicityDefault: z.infer<typeof juicitySchema> = {
  name: '',
  port: 0,
  server: '',
  congestion_control: '',
...
export const httpDefault: z.infer<typeof httpSchema> = {
  host: '',
  name: '',
  password: '',
  port: 0,
...
export const socks5Default: z.infer<typeof socks5Schema> = {
  host: '',
  name: '',
  password: '',
  port: 0,
